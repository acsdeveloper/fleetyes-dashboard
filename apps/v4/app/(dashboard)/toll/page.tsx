          ...
          {step === "upload" && (
            <>
              <div className="rounded-xl border bg-muted/30 p-4 text-xs">
                ...
                <p className="text-muted-foreground">Upload a <strong>.zip</strong> of JPEG/PNG toll receipt images. The system will OCR each image and extract toll details automatically.</p>
              </div>
    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="w-full max-w-md rounded-xl border bg-card shadow-2xl">
          <div className="flex items-center justify-between border-b px-5 py-4">
            <div>
              <h2 className="text-base font-bold">Send to Amazon</h2>
              <p className="mt-0.5 text-xs text-muted-foreground">Submit toll charges to Amazon Relay for the selected period</p>
            </div>
            <button onClick={onClose} className="rounded-lg border p-1.5 text-muted-foreground hover:bg-muted"><X className="h-4 w-4" /></button>
          </div>
          ...
          {!done ? (
            <div className="flex flex-col gap-4 p-5">
              ...
              <div className="rounded-lg bg-amber-50 dark:bg-amber-950/20 px-3 py-2 text-xs text-amber-800 dark:text-amber-300">
                This will submit all processed toll charges in the selected date range to Amazon Relay.
              </div>
              <div className="flex gap-2 mt-1">
                ...
                >
                  ...
                  {sending ? "Sending…" : "Send to Amazon"}
                </button>
              </div>
            </div>
          ) : (
            <div className="p-5">
              <div className="flex items-start gap-3 rounded-xl bg-green-50 dark:bg-green-950/20 p-4">
                <CheckCircle2 className="h-6 w-6 text-green-600 shrink-0 mt-0.5" />
                <div>
                  <p className="font-medium text-green-800 dark:text-green-300">Successfully sent to Amazon</p>
                  <p className="mt-0.5 text-xs text-muted-foreground">{fromDate} → {toDate}</p>
                </div>
              </div>
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 overflow-hidden">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        {[
          { label: "Total",     value: meta.total,    color: "text-foreground" },
