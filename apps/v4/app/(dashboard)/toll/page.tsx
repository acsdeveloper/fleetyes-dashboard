...
// ─── Add Receipts Modal (Full-screen two-panel) ───────────────────────────────
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4">
        <div className="flex w-full max-w-6xl flex-col overflow-hidden rounded-2xl border bg-card shadow-2xl" style={{ height: "92vh" }}>
                ...
                <div className="flex w-72 shrink-0 flex-col gap-4 border-r p-5">
                  ...
                  >
                    ...
                    <div className="px-4 text-center">
                      <p className="text-sm font-semibold">{dragging ? t.tollReceipts.dropActive : t.tollReceipts.dropTitle}</p>
                      <p className="mt-1 text-xs text-muted-foreground">{t.tollReceipts.dropHint}</p>
                    </div>
                  </div>
            ...
            {isProcessing && (
              <div className="flex flex-1 flex-col items-center justify-center gap-10 p-8">
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  {step === "processing" && <p className="text-sm text-muted-foreground">{t.tollReceipts.processingNote}</p>}
                </div>
              </div>
            )}
            ...
            {step === "done" && (
              <div className="flex flex-1 items-center justify-center p-8">
                <div className="flex w-full max-w-md items-start gap-4 rounded-2xl bg-green-50 p-6 dark:bg-green-950/20">
                  ...
                  <div>
                    <p className="font-semibold text-green-800 dark:text-green-300">{t.tollReceipts.successTitle}</p>
                    <p className="mt-1 text-sm text-muted-foreground">{t.tollReceipts.successCount.replace("{n}", String(importedCount)).replace("{s}", importedCount !== 1 ? "s" : "")}</p>
                  </div>
                </div>
              </div>
            )}
            ...
            {step === "error" && (
              <div className="flex flex-1 items-center justify-center p-8">
                <div className="flex w-full max-w-md items-center gap-4 rounded-2xl bg-red-50 p-6 dark:bg-red-950/20">
                  ...
                  <div>
                    <p className="font-semibold text-red-700 dark:text-red-400">{t.tollReceipts.errorTitle}</p>
          ...
          <div className="flex shrink-0 gap-3 border-t px-6 py-4">
            ...
            {step === "error" && (
              <>
                <button onClick={() => { setStep("select"); setErrMsg("") }} className="flex-1 rounded-lg border px-4 py-2 text-sm text-muted-foreground hover:bg-muted">{t.tollReceipts.btnTryAgain}</button>
